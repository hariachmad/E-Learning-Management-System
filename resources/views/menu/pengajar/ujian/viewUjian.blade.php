...
@section('container')
    ...
    <div class="mb-4 p-4 bg-white rounded-4">
        <div class=" p-4">
            ...
            <hr>
            <h3 class="fw-bold" style="color: #358508">{{ $ujian->name }} @if ($ujian->isHidden == 1)
            ...
            @if ($ujian->tipe == 'essay')
                <form action="{{ route('ujianUpdateNilai') }}" method="POST">
                    ...
                    @foreach ($ujian->SoalUjianEssay as $soal)
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class=" border border border-primary shadow-sm  p-4 mt-4 pertanyaan">
                                        <div class="">
                                            <h3>Soal <span class="badge badge-secondary">{{ $loop->iteration }}</span>
                                            </h3>
                                            <div class="mb-3">
                        ...
                        <hr>
                    @endforeach
                    <button class="btn btn-lg w-100" style="background-color: #358508; color: white" type="submit">Simpan</button>
                </form>
            @else
