        ...
        <div class="container col-xxl-8 px-4 py-5">
            ...
            <div class="row  align-items-center g-5 py-5">
                ...
                <div class="text-center">
                    <h3 class=" fw-bold d-block" style="color: #358508">Informasi Pengajar</h3>
                ...
                <div class="col-lg-4  col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            ...
                            <h1 class="display-3 fw-bold d-block" style="color: #358508">{{ $totalSiswaUnique }}</h1>
                        </div>
                    </div>
                </div>
                {{-- Total mapel --}}
                <div class="col-lg-4  col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            ...
                            <h1 class="display-3 fw-bold d-block" style="color : #358508">{{ count($mapelKelas) }}</h1>
                        </div>
                    </div>
                </div>
                {{-- Total kelas --}}
                <div class="col-lg-4 col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            ...
                            <h1 class="display-3 fw-bold d-block" style="color:#358508">{{ $countKelas }}</h1>
                        </div>
                    </div>
                </div>
                                                ...
                                                @foreach ($mapelKelasItem['kelas'] as $kelas)
                                                    <div class="col-12">
                                                        <a href="{{ route('viewKelasMapel', ['mapel' => $mapelKelasItem['mapel']->id, 'token' => encrypt($kelas['id']), 'mapel_id' => $mapelKelasItem['mapel']]) }}"
                                                            ...
                                                            <span class="my-1 badge badge-primary p-3" style="background-color: #358508">
                                                                {{ $kelas->name }}
                                                            </span>
                                                        </a>
