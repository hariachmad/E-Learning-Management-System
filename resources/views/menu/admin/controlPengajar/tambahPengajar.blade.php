        ...
        <div class="ps-4 pe-4">
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="p-4">
                        <h4 class="fw-bold" style="color:#358508"><i class="fa-solid fa-pen"></i> Data Pengajar</h4>
                        <form action="{{ route('validateDataPengajar') }}" method="POST">
                            ...
                            <div class="">
                                <button type="submit" class="btn-lg btn w-100" style="background-color: #358508; color: white;">Simpan dan Lanjutkan</button>
                            </div>
                        </form>
                    </div>
                </div>
