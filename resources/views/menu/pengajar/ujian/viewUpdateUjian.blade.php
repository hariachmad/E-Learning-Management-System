        ...
        <div class="row p-4">
            <div class="col-12 col-lg-12">
                <form action="{{ route('updateUjian') }}" method="POST">
                    @csrf
                    <h4 class="fw-bold" style="color: #358508"><i class="fa-solid fa-pen"></i> Data Ujian</h4>
                    <div class=" row ">
                        {{-- Section Left --}}
                        ...
                        <div class="mt-4">
                            <h4 class="fw-bold" style="color: #358508"><i class="fa-solid fa-pen"></i> Data Soal @if ($tipe == 'multiple')
                                    Pilihan Ganda
                                @else
                                    Essay
                                @endif
                                ...
                                @if (session()->has('soalEssay'))
                                    @foreach (session('soalEssay') as $key)
                                        <div class="bg-white border border-dark-subtle rounded-2 p-4 mt-4 pertanyaan">
                                            <div class="">
                                                <h3>Soal <span class="badge badge-secondary" style="background : #358508">{{ $loop->iteration }}</span>
                                                    <button type="button"
                        ...
                        <button type="submit" class="btn btn-lg btn-primary" style="background: #358508">Submit</button>
                </form>
            </div>
        </div>
    </div>
