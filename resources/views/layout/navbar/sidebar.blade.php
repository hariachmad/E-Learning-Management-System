<ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar" style="background-color: #358508">
    <!-- Sidebar - Brand -->
    ...
    @if (Auth()->User()->roles_id == 2)
        @foreach ($assignedKelas as $assignedKelasItem)
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item {{ explode('/', Request::segment(2))[0] == $assignedKelasItem['mapel']->id ? 'active' : '' }} ">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#collapseTarget{{ $loop->iteration }}" aria-expanded="true" aria-controls="collapseTarget">
