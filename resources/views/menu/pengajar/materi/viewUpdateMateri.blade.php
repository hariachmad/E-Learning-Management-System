...
@section('container')
    ...
    <div class="">
        <div class="row p-4">
            <h4 class="fw-bold" style="color: #358508"><i class="fa-solid fa-pen"></i> Data Materi</h4>
                ...
                <div class="mt-4">
                    <div class="p-4">
                        <form action="{{ route('updateMateri') }}" id="form-main" method="GET"
                            ...
                            {{-- Tombol Submit --}}
                            <div class="">
                                <button type="submit" id="btnSimpan" class="btn-lg btn w-100" style="background: #358508;color: white">Simpan dan
                                    Lanjutkan</button>
                            </div>
                        </form>
                    </div>
