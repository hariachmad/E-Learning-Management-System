...
@section('container')
    ...
    <div class="row ps-4 pe-4 mb-4" id="materi">
        ...
        <div class=" col-lg-12 col-md-12 mt-4">
            <h3 class=" fw-bold" style="color: #358508"><i class="fa-solid fa-book"></i> Materi
                @if (Auth()->User()->roles_id == 2)
                    <a
                ...
                <div class="row">
                    ...
                    <div class="  p-4 col-lg-6 col-12">
                        <div class="border border-primary rounded-2  h-100 p-3">
                            <h6 class="fw-bold text-center" style="color: #358508">Materi</h6>
        ...
        <div class=" col-lg-12 col-md-12 mt-4">
            <h3 class=" fw-bold " style="color: #358508"><i class="fa-solid fa-pen"></i> Tugas
                @if (Auth()->User()->roles_id == 2)
                    <a
            ...
            <div class="p-4 bg-white rounded-3">
                ...
                <div class="row">
                    ...
                    <div class="  p-4 col-lg-6 col-12">
                        <div class="border border-primary rounded-2  h-100 p-3">
                            <h6 class="fw-bold text-center" style="color: #358508">Tugas</h6>
    ...
    <div class="mb-4 ps-4 pe-4">
        <h3 class="fw-bold " style="color: #358508"><i class="fa-solid fa-newspaper"></i> Ujian
            @if (Auth()->User()->roles_id == 2)
                <a
