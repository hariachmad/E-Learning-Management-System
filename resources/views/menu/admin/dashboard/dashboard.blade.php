        ...
        <div class="container col-xxl-8 px-4 py-5">
            <div class="row  align-items-center g-5 py-5">
                ...
                <div class="text-center">
                    <h3 class="fw-bold d-block" style="color:#358508">Informasi Sistem</h3>
                </div>
                {{-- Total Siswa --}}
                <div class="col-lg-3 col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            ...
                            <br>
                            <Strong class="fs-5 d-block" style="color:#358508">Total Siswa</Strong>
                            <span class="small d-block">Total data siswa</span>
                            <h1 class="display-3 fw-bold d-block" style="color: #358508">{{ $data['totalSiswa'] }}</h1>
                        </div>
                    </div>
                </div>
                {{-- Total Siswa Unik --}}
                    ...
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/img/unique-user.svg') }}" alt="" class="img-fluid w-50"
                                srcset="" width="100px" style="max-width: 100px;">
                            <br>
                            <Strong class="fs-5 d-block" style="color: #358508">Siswa Terdaftar</Strong>
                            <span class="small d-block">Siswa yang memiliki akun</span>
                            <h1 class="display-3 fw-bold d-block" style="color:#358508">{{ $data['totalUserSiswa'] }}</h1>
                        </div>
                    </div>
                </div>
                {{-- Total mapel --}}
                    ...
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/img/kelas-icon.svg') }}" alt="" class="img-fluid w-50"
                                srcset="" width="100px" style="max-width: 100px;">
                            <br>
                            <Strong class="fs-5 d-block" style="color:#358508">Total Pengajar</Strong>
                            <span class="small d-block">User pengajar</span>
                            <h1 class="display-3 fw-bold d-block" style="color: #358508">{{ $data['totalPengajar'] }}</h1>
                        </div>
                    </div>
                </div>
                {{-- Total kelas --}}
                    ...
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/img/mapel-icon.svg') }}" alt="" class="img-fluid w-50"
                                srcset="" width="100px" style="max-width: 100px;">
                            <br>
                            <Strong class="fs-5 d-block" style="color:#358508">Total Kelas</Strong>
                            <span class="small d-block">Semua kelas</span>
                            <h1 class="display-3 fw-bold d-block" style="color : #358508">{{ $data['totalKelas'] }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/img/mapel.svg') }}" alt="" class="img-fluid w-50"
                                srcset="" width="100px" style="max-width: 100px;">
                            <br>
                            <Strong class="fs-5 d-block" style="color:#358508">Total Mapel</Strong>
                            <span class="small d-block">Mapel yang terdaftar</span>
                            <h1 class="display-3 fw-bold d-block" style="color: #358508">{{ $data['totalMapel'] }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/img/materi.svg') }}" alt="" class="img-fluid w-50"
                                srcset="" width="100px" style="max-width: 100px;">
                            <br>
                            <Strong class="fs-5 d-block" style="color: #358508">Total Materi</Strong>
                            <span class="small d-block">Materi yang terdaftar</span>
                            <h1 class="display-3 fw-bold d-block" style="color: #358508">{{ $data['totalMateri'] }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/img/tugas.svg') }}" alt="" class="img-fluid w-50"
                                srcset="" width="100px" style="max-width: 100px;">
                            <br>
                            <Strong class="fs-5 d-block" style="color: #358508">Total Tugas</Strong>
                            <span class="small d-block">Tugas yang terdaftar</span>
                            <h1 class="display-3 fw-bold d-block" style="color: #358508">{{ $data['totalTugas'] }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/img/ujian.svg') }}" alt="" class="img-fluid w-50"
                                srcset="" width="100px" style="max-width: 100px;">
                            <br>
                            <Strong class="fs-5 d-block" style="color: #358508">Total Ujian</Strong>
                            <span class="small d-block">Ujian yang terdaftar</span>
                            <h1 class="display-3 fw-bold d-block" style="color: #358508">{{ $data['totalUjian'] }}</h1>
                        </div>
                    </div>
                </div>
