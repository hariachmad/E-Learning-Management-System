...
@section('container')
                ...
                <div class="">
                    <div class=" p-4">
                        <form action="{{ route('validateDataPengajarKelas') }}" method="POST">
                            @csrf
                            <h4 class="fw-bold" style="color: #358508"><i class="fa-solid fa-pen"></i> Data Kelas Pengajar</h4>
        ...
        <div class="col-12 mt-4 bg-white rounded-2">
            <div class="mt-4">
                <div class="p-4">
                    <div class="row">
                        <div class="col-3">
                            <h3 class="fw-bold" style="color : #358508"><i class="fa-solid fa-book-bookmark"></i> Kelas & Mapel</h3>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2">
                                    ...
                                    <button disabled class="d-block mt-2 btn w-100" style="background: #358508; color: white;" id="btnTambah"
    ...
    <div class="mt-3">
        <button type="submit" class="btn-lg btn w-100" style="background: #358508; color: white;">Simpan dan Lanjutkan</button>
    </div>
