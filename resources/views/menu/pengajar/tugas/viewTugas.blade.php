                ...
                <div class="row">
                    ...
                    <div class="mb-4 p-4 bg-white rounded-4">
                        <div class=" p-4">
                            ...
                            <div class="row">
                                <h3 class="fw-bold" style="color : #358508">{{ $tugas->name }}@if ($tugas->isHidden == 1)
                    ...
                    @if (Auth()->User()->roles_id == 2)
                        <form action="{{ route('siswaUpdateNilai', ['token' => encrypt($tugas['id'])]) }}" method="post">
                            ...
                            <button class="btn w-100" style="background: #358508;color: white" type="submit">submit</button>
                        </form>
                        ...
                        <ul class="list-group">
                            @foreach ($tugasAll as $key)
                                @if ($key->isHidden != 1 || Auth()->User()->roles_id == 2)
                                    ...
                                    @endif
                                    <li style="background: #358508; color: white;" class="list-group-item  @if ($tugas['id'] == $key->id) active @endif">
                                        {{ $key->name }}
                                    </li>
                                    @if ($tugas['id'] != $key->id)
                                        </a>
